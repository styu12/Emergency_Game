...
export const dataContents = [
    {
        general: [
            {
                title: "서울은 전국에서 평균 응급실 포화도가 가장 높은 지역이다.",
                img: '/data/0_big.png',
                description: `응급실 포화도가 100% 이상이라는 것은 이 응급실에 방문하여 서비스를 받을 확률이 평균적으로 0에 가깝다는 것을 의미한다.`,
            }, 
            {
                title: `서울 응급실 전원 사유의 53%는 '병실 부족'이다.
                타 지역에서 '병실 부족'은 전체 전원 사유의 평균 4% 밖에 되지 않는다.`,
                img: '/data/0_big_2.png',
                description: ``,
            }
        ],
        local: [
            {
                title: "지역응급의료기관에도 응급환자는 많지만, 그에 비해 응급의학전문의 수는 턱없이 적어 인력문제에 시달린다.",
                img: '/data/0_small.png',
                description: ``,
            },
            {
                title: `지역응급의료기관에서 중증환자의 전원율은 질병에 따라 절반 가까이 되기도 한다.`,
                img: '/data/0_small_2.png',
                description: ``,
            }
        ]
    },

    {
        general: [
            {
                title: "대구는 전국에서 평균 응급실 포화도가 가장 높은 지역 중 하나이다.",
                img: '/data/1_big.png',
                description: `응급실 포화도가 100% 이상이라는 것은 이 응급실에 방문하여 서비스를 받을 확률이 평균적으로 0에 가깝다는 것을 의미한다.`,
            }, 
            {
                title: `하지만 응급실 내원 환자들 중 절반 이상은 경증 환자이다.
                경증환자로 병상이 가득 차면 새로 오는 중증환자를 받지 못할 가능성이 커진다.`,
                img: '/data/1_big_2.png',
                description: ``,
            }
        ],
        local: [
            {
                title: `대구는 전원율이 3.1%로 전국에서 2번째로 높고, 
                재전원율은 4.9%로 전국에서 가장 높다.`,
                img: '/data/1_small.png',
                description: `2021년에는 대구에서 261명의 중증응급환자가 소위 '응급실 뺑뺑이'를 경험했다.`,
            },
            {
                title: `그 이유는 대구 병원 구성의 특성과 관련되어 있다.`,
                img: '/data/1_small_2.png',
                description: `대구는 중간급에 해당하는 2차 병원의 수가 부족해, 원래라면 2차병원으로 갔어야 할 경증환자들이 상급종합병원으로 몰리고 있다.`,
            }
        ]
    },
    {
        ...
        local: [
            {
                title: `전남 지역 전원율은 3.3%로 전국에서 가장 높다. 
                그 중 절반은 적절한 응급의료를 제공할 인력이나 장비가 부족하기 때문에 전원된다.`,
                img: '/data/2_small.png',
                description: ``,
            }, 
            {
